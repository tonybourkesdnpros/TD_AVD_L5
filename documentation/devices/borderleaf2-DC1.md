...
| --------- | --------------- | ------------ | --------- |
| dc1_bl | Vlan4094 | 10.255.252.8 | Port-Channel1 |
...
| Ethernet12 | P2P_LINK_TO_DCI_Ethernet2 | routed | - | 192.168.99.2/31 | default | 1500 | False | - | - |
...
| 192.168.99.3 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65104
   ...
   neighbor 192.168.99.3 description DCI
