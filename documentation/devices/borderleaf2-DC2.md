...
| --------- | --------------- | ------------ | --------- |
| dc2_bl | Vlan4094 | 10.255.252.8 | Port-Channel1 |
...
| Ethernet12 | P2P_LINK_TO_DCI_Ethernet2 | routed | - | 192.168.99.6/31 | default | 1500 | False | - | - |
...
| 192.168.99.7 | 65000 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 192.168.201.11 | 65002 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - |
| 192.168.201.12 | 65002 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - |
...
| 192.168.203.30 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.203.32 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.203.34 | 65002 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65204
   ...
   neighbor 192.168.99.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.99.7 remote-as 65000
   neighbor 192.168.99.7 description DCI
